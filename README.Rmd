...
[![License for slide deck](https://img.shields.io/badge/license (for slide decks)-CC BY 4.0-blue)](https://creativecommons.org/licenses/by/4.0/)
[![Test render slides](https://github.com/OxfordIHTM/open-reproducible-science/actions/workflows/test_render_slide.yml/badge.svg)](https://github.com/OxfordIHTM/open-reproducible-science/actions/workflows/test_render_slide.yml)
[![Publish slides](https://github.com/OxfordIHTM/open-reproducible-science/actions/workflows/publish_slides.yml/badge.svg)](https://github.com/OxfordIHTM/open-reproducible-science/actions/workflows/publish_slides.yml)
...
Slides can be viewed [here](https://oxford-ihtm.io/open-reproducible-science/session1.html).

PDF version of slides can be downloaded [here](https://oxford-ihtm.io/open-reproducible-science/pdf/session1-getting-the-right-tools.pdf).
