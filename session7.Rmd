...
* RStudio, git, and GitHub process for participating in an R-based scientific project/workflow

* RStudio, git, and GitHub process for initiating your own R-based scientific project/workflow
