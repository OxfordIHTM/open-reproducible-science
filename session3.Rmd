...
* The current state of (global health) data

* An opinionated perspective on working with data in R
...
# The current state of (global health) data in tweets and quotes
